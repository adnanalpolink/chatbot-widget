...
(function() {
    ...
    // Handle registration form submission - ENHANCED WITH PHONE
    async function handleRegistration(event) {
        ...
        try {
            ...
            // Send user info as first message - ENHANCED WITH PHONE
    ...
    // Send a message to the webhook - ENHANCED WITH PHONE METADATA
    async function submitMessage(messageText) {
        if (isWaitingForResponse) return;
        
        isWaitingForResponse = true;
        
        // Get user info if available - ENHANCED WITH PHONE
