// Interactive Chat Widget for n8n - Enhanced with Phone Field
(function() {
    ...
    // Create welcome screen with header - ENHANCED WITH PHONE FIELD
    ...
    // Registration form elements - ENHANCED WITH PHONE
    ...
    // Validate phone format - Enhanced validation
    ...
    // Handle registration form submission - SIMPLIFIED FOR N8N ALIGNMENT
    async function handleRegistration(event) {
        ...
        // Store user info for use in messages
        userInfo = {
            name: name,
            email: email,
            phone: phone
        ...
        try {
            ...
            // Send user info as the first message to n8n
            const userInfoMessage = `Name: ${name}\nEmail: ${email}\nPhone: ${phone}`;
            await submitMessage(userInfoMessage);
    ...
    // Send a message to the webhook - ENHANCED FOR N8N ALIGNMENT
    async function submitMessage(messageText) {
        if (isWaitingForResponse) return;
        
        isWaitingForResponse = true;
        
        // Build request data for n8n
        const requestData = {
            action: "sendMessage",
